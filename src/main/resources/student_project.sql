...
(
	...
	FOREIGN KEY (passport_office_area_id) REFERENCES jc_country_struct(area_id) ON DELETE RESTRICT
);
...
(
    ...
    marriage_certificate_number varchar(20) not null,
    register_office_id integer not null,
...
(
    ...
    FOREIGN KEY (c_register_office_id) REFERENCES jc_register_office(register_office_id) ON DELETE RESTRICT
);
